  ...
  <div class="two-col">
    <div>
      ...
      <div class="about-links">
        ...
        <a href="resume.pdf" class="tag" target="_blank" rel="noopener">Resume</a>
        <a href="https://linkedin.com/in/eesha-jagdhane" class="tag">LinkedIn</a>
        <a href="https://github.com/eeshajagdhane?tab=repositories" class="tag">GitHub</a>
      </div>
    </div>
    <div>
...
<div class="section" id="experience">
  ...
  <div class="exp-item">
    <div class="exp-date">Mar 2026 – Jun 2026</div>
    <div>
      <div class="exp-title">AI Engineer</div>
      <div class="exp-company">Dhauz | QuantumRise — San Diego, CA, U.S.A</div>
      <div class="exp-desc">In my MSBA capstone with Dhauz AI Consulting and Quantum Rise, I work at the intersection of business requirements, healthcare workflows, and technical implementation. I translate nurse workflows into user stories, alert logic, and usability criteria for a Telegram-based AI prototype designed to support patient deterioration monitoring. I also coordinate weekly agendas, presentations, and recap emails across client, partner, and UCSD stakeholders to clarify open questions, align technical decisions with end-user needs, and keep the project moving toward implementation.tential for earlier intervention, lower care costs, reduced ICU escalations, and improved nurse retention.</div>
    </div>
  ...
  <div class="exp-item">
    ...
    <div>
      ...
      <div class="exp-desc">As a Data Analyst at Morningstar DBRS, I improved reporting workflows, data quality, and stakeholder visibility across structured finance teams. I standardized 20+ Tableau Prep workflows and dashboards by translating stakeholder reporting needs into reusable metrics, filters, and documentation, giving 10+ teams self-service access to deal inflow and issuance insights. I also validated SQL, Python, and Excel reporting workflows by reconciling source data to dashboard outputs, debugging metric inconsistencies, and improving trust in reporting used by internal business teams.</div>
    </div>
    <div class="exp-badges">
      <span class="badge">SQL</span>
      <span class="badge">Python</span>
  ...
  <div class="exp-item">
    ...
    <div>
      ...
      <div class="exp-company">Morningstar DBRS — Chicago, IL, U.S.A</div>
      <div class="exp-desc">As a Credit Ratings Analyst at Morningstar DBRS, I supported credit decision-making through quantitative financial analysis, scenario modeling, and disciplined quality checks. I performed 15+ cash flow and scenario analyses across multiple commercial real estate property types under tight deadlines and high-volume deal flow. I maintained 99% accuracy across complex financial models through structured QA reviews, attention to detail, and consistent validation of assumptions and outputs.</div>
    </div>
    <div class="exp-badges">
  ...
  <div class="exp-item">
    <div class="exp-date">Jun 2021 – Jul 2021</div>
    <div>
      <div class="exp-title">Machine Learning Intern</div>
      <div class="exp-company">Centre for Development of Advanced Computing</div>
      <div class="exp-desc">As a Machine Learning Intern at CDAC, I supported an image distortion recognition project focused on incremental learning and similarity-based image comparison. I developed a beta incremental learning model using NumPy, Pandas, TensorFlow, and Keras to support continuous model updates as new image data was introduced, achieving 0.981 testing accuracy and 0.999 training accuracy. I also implemented a similarity-index approach to compare original and distorted images, strengthening my experience in model development, data preprocessing, and technical experimentation.</div>
    </div>
    <div class="exp-badges">
      <span class="badge">Python</span>
  ...
  <div class="two-col">
    ...
    <div>
      <div class="food-grid">
        ...
        <img src="Pictures/CallofDuty.jpeg" alt="Food">
        <img src="Pictures/Books.jpeg" alt="Food">
        <img src="Pictures/Painting.jpeg" alt="Food">
      </div>
    </div>
  </div>
</div>
