...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .blog-empty-title {
    ...
    color: #2e2825; margin-bottom: 0.75rem;
  }
  .blog-empty-desc {
...
<!-- NAV -->
<div class="nav">
  <a href="index.html" class="nav-logo">Eesha Jagdhane // Portfolio</a>
  <ul class="nav-links">
...
<div class="page-header">
  ...
  <p class="page-sub">
    A collection of projects, experiments, and reflections — from personal builds and
    GitHub work to the ideas I'm exploring and learning along the way.
  </p>
</div>
...
<div class="blog-section">
  <div class="blog-empty">
    <div class="blog-empty-title">More coming soon</div>
    <p class="blog-empty-desc">
      New writing, analyses, and reflections will be published here soon. Stay tuned!
    </p>
  </div>
</div>
